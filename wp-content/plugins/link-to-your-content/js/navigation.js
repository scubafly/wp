...
var invalidSite = tinyMCEPopup.getWindowArg('invalidSite');
var siteChangeError = tinyMCEPopup.getWindowArg('siteChangeError');
var requestError = tinyMCEPopup.getWindowArg('requestError');
var invalidPage = tinyMCEPopup.getWindowArg('invalidPage');
var invalidPanel = tinyMCEPopup.getWindowArg('invalidPanel');
var invalidCPT = tinyMCEPopup.getWindowArg('invalidCPT');
var invalidTax = tinyMCEPopup.getWindowArg('invalidTax');
